...
# goods_production <- letters[seq( from = 1, to = 5 )]
# service_provision <- letters[seq(from = 7, to = 17)]
...
UK_Labour_Productivity_Jobs_in_Regions_by_Industry <- read_excel("raw_data/data/UK_productivity/UK Labour Productivity - Jobs in Regions by Industry.xls", 
    ...
    mutate(year_month = format(as.Date(as.yearmon(str_sub(year_month, 0, -4), "%b %y")), "%b %y")) %>%
